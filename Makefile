...
check:
	...
	bash -n scripts/run-baseline.sh scripts/run-v35-phase.sh scripts/run-v36-phase-profiler.sh scripts/run-v37-cadence-alignment.sh scripts/run-v38-early-submit.sh scripts/pi-debug.sh scripts/pi-run-and-package.sh
